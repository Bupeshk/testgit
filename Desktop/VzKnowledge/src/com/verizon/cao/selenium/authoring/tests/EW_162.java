...
@Test
public class EW_162 extends SetupBase implements Authoring {

	public static ExtentReports ext_report = new ExtentReports(RepConstants.REPORT_PATH+ "\\AuthoringOwnerSearchPageTest.html", true,
			DisplayOrder.OLDEST_FIRST);
	private ExtentTest test;
	CommonFunctions common = new CommonFunctions();
	private String  baseurl ;
	public EW_162() throws Exception {
		super();
	}
	//@BeforeSuite
	@Test
	...
	
	{
		...
		Thread.sleep(1000);
		test.log(LogStatus.PASS, "AuthoringOwnerSearchPageTest", "folderAccountSupport clicked successfully done");
		CommonFunctions.SelDropDown(selectsearch,"Owner",driver);
		AuthoringContentPage.txtsearch(driver).sendKeys("a");
		AuthoringContentPage.buttonsearch(driver).click();
		test.log(LogStatus.PASS, "AuthoringOwnerSearchPageTest", "buttonsearch clicked successfully done");
		common.existsElement(driver, verifyresult);

		test.log(LogStatus.PASS, "AuthoringOwnerSearchPageTest", "Test case successfully done");
	...
	public  void setUp()throws Exception {
		...
		ext_report.config().reportName("AuthoringOwnerSearchPageTest");
		ext_report.config().reportHeadline("-AuthoringOwnerSearchPageTest");
