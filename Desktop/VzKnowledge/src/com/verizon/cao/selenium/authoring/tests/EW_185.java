...
@Test
public class EW_185 extends SetupBase implements Authoring {

	public static ExtentReports ext_report = new ExtentReports(RepConstants.REPORT_PATH+ "\\AuthoringFinancePageTest.html", true,
			DisplayOrder.OLDEST_FIRST);
	private ExtentTest test;
	CommonFunctions common = new CommonFunctions();
	private String  baseurl ;
	public EW_185() throws Exception {
		super();
	}
	//@BeforeSuite
	@Test
	...
	Thread.sleep(1000);
	test.log(LogStatus.PASS, "AuthoringFinancePageTest", "folderAccountSupport clicked successfully done");
		...
		test.log(LogStatus.PASS, "AuthoringFinancePageTest", "btnsearch clicked successfully done");
		...
		test.log(LogStatus.PASS, "AuthoringFinancePageTest", "Test case successfully done");

	}
	@BeforeClass
	public  void setUp()throws Exception {
		DOMConfigurator.configure("log4j.xml");
		Log.startTestCase("AuthoringFinancePageTest");
		Log.info("BeforeClass Method Invoked");
		ext_report.config().documentTitle("VzKnowledge Automation");
		ext_report.config().reportName("AuthoringFinancePageTest");
		ext_report.config().reportHeadline("-AuthoringFinancePageTest");
