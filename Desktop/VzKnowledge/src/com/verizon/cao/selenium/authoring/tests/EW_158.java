...
@Test
public class EW_158 extends SetupBase implements Authoring {

	public static ExtentReports ext_report = new ExtentReports(RepConstants.REPORT_PATH+ "\\AuthoringPublishingContentEnduserPageTest.html", true,
			DisplayOrder.OLDEST_FIRST);
	private ExtentTest test;
	CommonFunctions common = new CommonFunctions();
	private String  baseurl ;
	public EW_158() throws Exception {
		super();
	}
	//@BeforeSuite
	@Test
	...
	
	{
		...
		test.log(LogStatus.PASS, "AuthoringPublishingContentEnduserPageTest", "lnkTaxonomy Clicked successfully done");
		common.existsElement(driver, eledocnum);
		test.log(LogStatus.PASS, "AuthoringPublishingContentEnduserPageTest", "Test case successfully done");
	}
	@BeforeClass
	public  void setUp()throws Exception {
		DOMConfigurator.configure("log4j.xml");
		Log.startTestCase("AuthoringPublishingContentEnduserPageTest");
		Log.info("BeforeClass Method Invoked");
		ext_report.config().documentTitle("VzKnowledge Automation");
		ext_report.config().reportName("AuthoringPublishingContentEnduserPageTest");
		ext_report.config().reportHeadline("-AuthoringPublishingContentEnduserPageTest");
