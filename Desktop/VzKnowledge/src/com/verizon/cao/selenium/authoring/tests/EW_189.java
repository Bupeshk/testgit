...
@Test
public class EW_189 extends SetupBase implements Authoring {

	public static ExtentReports ext_report = new ExtentReports(RepConstants.REPORT_PATH+ "\\AuthoringFinancePublishingContentEnduserPageTest.html", true,
			DisplayOrder.OLDEST_FIRST);
	private ExtentTest test;
	CommonFunctions common = new CommonFunctions();
	private String  baseurl ;
	public EW_189() throws Exception {
		super();
	}
	//@BeforeSuite
	@Test
	...
	
	{
		...
		test.log(LogStatus.PASS, "AuthoringFinancePublishingContentEnduserPageTest", "Test case successfully done");
	}
	@BeforeClass
	public  void setUp()throws Exception {
		DOMConfigurator.configure("log4j.xml");
		Log.startTestCase("AuthoringFinancePublishingContentEnduserPageTest");
		Log.info("BeforeClass Method Invoked");
		ext_report.config().documentTitle("VzKnowledge Automation");
		ext_report.config().reportName("AuthoringFinancePublishingContentEnduserPageTest");
		ext_report.config().reportHeadline("-AuthoringFinancePublishingContentEnduserPageTest");
