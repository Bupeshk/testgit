...
@Test
public class EW_166 extends SetupBase implements Authoring {

	CommonFunctions common = new CommonFunctions();
	private String  baseurl ;
	public EW_166() throws Exception {
		super();
	}
	//@BeforeSuite
	@Test
	...
	
	{
		...
		AuthoringContentPage.radiocustom(driver).click();
		AuthoringContentPage.txttitle(driver).sendKeys("testing");
