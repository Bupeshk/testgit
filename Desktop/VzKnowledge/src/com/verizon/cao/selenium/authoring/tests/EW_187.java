...
@Test
public class EW_187 extends SetupBase implements Authoring {

	public static ExtentReports ext_report = new ExtentReports(RepConstants.REPORT_PATH+ "\\AuthoringFinanceContentActionsPageTest.html", true,
			DisplayOrder.OLDEST_FIRST);
	private ExtentTest test;
	CommonFunctions common = new CommonFunctions();
	private String  baseurl ;
	public EW_187() throws Exception {
		super();
	}
	//@BeforeSuite
	@Test
	...
	Thread.sleep(1000);
	test.log(LogStatus.PASS, "AuthoringFinanceContentActionsPageTest", "folderAccountSupport clicked successfully done");
		...
		test.log(LogStatus.PASS, "AuthoringFinanceContentActionsPageTest", "btnsubmit clicked successfully done");
		...
		test.log(LogStatus.PASS, "AuthoringFinanceContentActionsPageTest", "btnsave clicked successfully done");
		...
		test.log(LogStatus.PASS, "AuthoringFinanceContentActionsPageTest", "Test case successfully done");
	...
	public  void setUp()throws Exception {
		...
		Log.startTestCase("AuthoringFinanceContentActionsPageTest");
		Log.info("BeforeClass Method Invoked");
		ext_report.config().documentTitle("VzKnowledge Automation");
		ext_report.config().reportName("AuthoringFinanceContentActionsPageTest");
		ext_report.config().reportHeadline("-AuthoringFinanceContentActionsPageTest");
