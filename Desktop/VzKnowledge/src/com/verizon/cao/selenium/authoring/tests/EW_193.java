...
@Test
public class EW_193 extends SetupBase implements Authoring {

	public static ExtentReports ext_report = new ExtentReports(RepConstants.REPORT_PATH+ "\\AuthoringNetworkTechnologyContentActionsPageTest.html", true,
			DisplayOrder.OLDEST_FIRST);
	private ExtentTest test;
	CommonFunctions common = new CommonFunctions();
	private String  baseurl ;
	public EW_193() throws Exception {
		super();
	}
	//@BeforeSuite
	@Test
	...
	
	{
		...
		Thread.sleep(1000);
		test.log(LogStatus.PASS, "AuthoringNetworkTechnologyContentActionsPageTest", "folderAccountSupport clicked successfully done");
		...
		test.log(LogStatus.PASS, "AuthoringNetworkTechnologyContentActionsPageTest", "btnsave clicked successfully done");
		...
		test.log(LogStatus.PASS, "AuthoringNetworkTechnologyContentActionsPageTest", "Test case successfully done");

	}
	@BeforeClass
	public  void setUp()throws Exception {
		DOMConfigurator.configure("log4j.xml");
		Log.startTestCase("AuthoringNetworkTechnologyContentActionsPageTest");
		Log.info("BeforeClass Method Invoked");
		ext_report.config().documentTitle("VzKnowledge Automation");
		ext_report.config().reportName("AuthoringNetworkTechnologyContentActionsPageTest");
		ext_report.config().reportHeadline("-AuthoringNetworkTechnologyContentActionsPageTest");
