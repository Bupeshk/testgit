...
public class EW_220  extends SetupBase implements Admin,Common {
	...
	public static ExtentReports ext_report = new ExtentReports(ApplicationConstants.REPORT_PATH + "\\EW_220.html", true,DisplayOrder.OLDEST_FIRST);
	private ExtentTest test; 

	public EW_220() throws Exception {
		super();
	}
	...
	public void ProfileReportPageTest() throws Exception
	{
		...
		ReportsPage.MoreReportTabs(driver, "Profile Report").click();
		Thread.sleep(2000);
		CommonFunctions.waitForElementPresentWebdriver(attributeName_xpath, imgBusinessGroup, "Business Group drop down list", driver, null, test);
		...
		String filePATH = "C:\\Users\\CHELLME\\Downloads\\vzk_profilereportUsers_Modified.xlsx";
		...
		CommonFunctions.waitForElementPresentWebdriver(attributeName_xpath, txtProfileReportTitle, "Profile Report", driver, ext_report, test);
		...
		Thread.sleep(4000);
		int numberOfRows = CommonFunctions.checkRowsForColumn("Title","C:\\Users\\CHELLME\\Downloads\\vzk_profilereportUsers_Modified.xlsx", "Sheet1");
		System.out.println("number of rows" +numberOfRows);
		AdminUtils.excelReader("C:\\Users\\CHELLME\\Downloads\\vzk_profilereportUsers_Modified.xlsx","Sheet1");
	...
	public  void setUp()throws Exception {
		Log.startTestCase("EW_220");
		Log.info("BeforeClass Method Invoked");
		ext_report.config().documentTitle("VzKnowledge Automation");
		ext_report.config().reportName("EW_220");
		ext_report.config().reportHeadline("-EW_220"); 
