...
public class EW_216  extends SetupBase implements Admin,Common {
	...
	public static ExtentReports ext_report = new ExtentReports(ApplicationConstants.REPORT_PATH + "\\EW_216.html", true,DisplayOrder.OLDEST_FIRST);
	private ExtentTest test; 
	public EW_216() throws Exception {
		super();
	}

	@Test
	public void FeedBackReportGeneralPageTest() throws Exception
	{
		test = ext_report.startTest("EW_216");
		ReportsPageTest reportsPageTest = new ReportsPageTest();
		reportsPageTest.ReportsPageTest();
		ReportsPage.ReportTabs(driver, "Feedback Report - General").click();
		Thread.sleep(1000);
		...
		Thread.sleep(2000);
		driver.findElement(By.xpath("//td//a[text() = 'ALERTS']")).click();
		Thread.sleep(4000);
		driver.findElement(By.xpath(lnkViewFeedback)).click();
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(txtFeedBackReport_General_Title)));
		...
		String filePATH = "C:\\Users\\CHELLME\\Downloads\\vzk_Feedback_Modified.xlsx";
		...
		Thread.sleep(4000);
		int numberOfRows = CommonFunctions.checkRowsForColumn("Title","C:\\Users\\CHELLME\\Downloads\\vzk_Feedback_Modified.xlsx", "Sheet1");
		System.out.println("number of rows" +numberOfRows);
		AdminUtils.excelReader("C:\\Users\\CHELLME\\Downloads\\vzk_Feedback_Modified.xlsx","Sheet1");
	...
	public  void setUp()throws Exception {
		Log.startTestCase("EW_216");
		Log.info("BeforeClass Method Invoked");
		ext_report.config().documentTitle("VzKnowledge Automation");
		ext_report.config().reportName("EW_216");
		ext_report.config().reportHeadline("-EW_216"); 
