...
public class EW_224  extends SetupBase implements Admin,Common {
	...
	public static ExtentReports ext_report = new ExtentReports(ApplicationConstants.REPORT_PATH + "\\EW_224.html", true,DisplayOrder.OLDEST_FIRST);
	private ExtentTest test; 

	public EW_224() throws Exception {
		super();
	}

	@Test
	public void PortletReportPageTest() throws Exception
	{
		...
		ReportsPage.MoreReportTabs(driver, "Portlet Report").click();
		CommonFunctions.waitForElementPresentWebdriver(attributeName_xpath, imgPortletName, "Business Group drop down list", driver, ext_report, test);
		...
		Thread.sleep(2000);
		driver.findElement(By.xpath(imgPortletName)).click();
		...
		driver.findElement(By.xpath(chkPortletName)).click();
		ContentReadReportsPage.Apply_btn(driver).click();
		Thread.sleep(4000);
		
		String filePATH = "C:\\Users\\CHELLME\\Downloads\\Portlet_Modified.xlsx";
		CommonFunctions.FileExists(driver,filePATH, ext_report, test);
		//clicking on viewed user link
		//driver.findElement(By.xpath("//td[text() = 'VES']//following-sibling::td//a")).click();
		Thread.sleep(4000);
		...
		//CommonFunctions.waitForElementPresentWebdriver(attributeName_xpath, txtChunkingReportTitle, txtChunkingReportTitle, driver);
		...
		Thread.sleep(4000);
		int numberOfRows = CommonFunctions.checkRowsForColumn("User Name","C:\\Users\\CHELLME\\Downloads\\Portlet_Modified.xlsx", "Sheet1");
		System.out.println("number of rows" +numberOfRows);
		AdminUtils.excelReader("C:\\Users\\CHELLME\\Downloads\\Portlet_Modified.xlsx","Sheet1");
	...
	public  void setUp()throws Exception {
		Log.startTestCase("EW_224");
		Log.info("BeforeClass Method Invoked");
		ext_report.config().documentTitle("VzKnowledge Automation");
		ext_report.config().reportName("EW_224");
		ext_report.config().reportHeadline("-EW_224"); 
