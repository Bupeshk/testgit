...
public class EW_213  extends SetupBase implements Admin,Common {
	...
	public static ExtentReports ext_report = new ExtentReports(ApplicationConstants.REPORT_PATH + "\\EW_213.html", true,DisplayOrder.OLDEST_FIRST);
	private ExtentTest test; 
	public EW_213() throws Exception {
		super();
	}

	@Test
	public void MetadataSubscriptionReportPageTest() throws Exception
	{
		test = ext_report.startTest("EW_213");
		ReportsPageTest reportsPageTest = new ReportsPageTest();
		reportsPageTest.ReportsPageTest();
		ReportsPage.ReportTabs(driver, "Metadata Subscription Report").click();
		Thread.sleep(2000);
		CommonFunctions.waitForElementPresentWebdriver(attributeName_xpath, imgBusinessGroup, "Business Group drop down list", driver, ext_report, test);
		...
		String filePATH = "C:\\Users\\CHELLME\\Downloads\\vzk_SubscribedUsers_Modified.xlsx";
		CommonFunctions.FileExists(driver,filePATH, ext_report, test);
		//clicking on viewed user link
		driver.findElement(By.xpath("//td//a[text() = 'APAC']")).click();
		Thread.sleep(4000);
		driver.findElement(By.xpath(lnkViewSubscribedUsers)).click();
		Thread.sleep(5000);
		//wait1.until(ExpectedConditions.titleIs(title)visibilityOfElementLocated(By.xpath(lblPleaseWait)));
		CommonFunctions.waitForElementPresentWebdriver(attributeName_xpath, txtMetaData_Subscription_ReportTitle, "Metadata Subscription Report", driver, ext_report, test);
		...
		commonFunctions.clkElement(driver,lnkExcel,lnkExcel, null, test);
		Thread.sleep(2000);
		...
		Thread.sleep(4000);
		int numberOfRows = CommonFunctions.checkRowsForColumn("User Name","C:\\Users\\CHELLME\\Downloads\\vzk_SubscribedUsers_Modified.xlsx", "Sheet1");
		System.out.println("number of rows" +numberOfRows);
		AdminUtils.excelReader("C:\\Users\\CHELLME\\Downloads\\vzk_SubscribedUsers_Modified.xlsx","Sheet1");
	...
	public  void setUp()throws Exception {
		Log.startTestCase("EW_213");
		Log.info("BeforeClass Method Invoked");
		ext_report.config().documentTitle("VzKnowledge Automation");
		ext_report.config().reportName("EW_213");
		ext_report.config().reportHeadline("-EW_213"); 
