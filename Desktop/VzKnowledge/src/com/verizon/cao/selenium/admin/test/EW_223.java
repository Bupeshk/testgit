...
public class EW_223  extends SetupBase implements Admin,Common {
	...
	public static ExtentReports ext_report = new ExtentReports(ApplicationConstants.REPORT_PATH + "\\EW_223.html", true,DisplayOrder.OLDEST_FIRST);
	private ExtentTest test; 
	public EW_223() throws Exception {
		super();
	}
	...
	{
		test = ext_report.startTest("ProfileReportPageTest");
		...
		ReportsPage.MoreReportTabs(driver, "Required Reading Report").click();
		Thread.sleep(2000);
		...
		String filePATH = "C:\\Users\\CHELLME\\Downloads\\Required Items Read Detail_Modified.xlsx";
		...
		CommonFunctions.waitForElementPresentWebdriver(attributeName_xpath, txtRequiredReadingReportTitle, "Required Reading Report", driver, ext_report, test);
		...
		Thread.sleep(4000);
		int numberOfRows = CommonFunctions.checkRowsForColumn("Role","C:\\Users\\CHELLME\\Downloads\\Required Items Read Detail_Modified.xlsx", "Sheet1");
		System.out.println("number of rows" +numberOfRows);
		AdminUtils.excelReader("C:\\Users\\CHELLME\\Downloads\\Required Items Read Detail_Modified.xlsx","Sheet1");
	...
	public  void setUp()throws Exception {
		Log.startTestCase("EW_223");
		Log.info("BeforeClass Method Invoked");
		ext_report.config().documentTitle("VzKnowledge Automation");
		ext_report.config().reportName("EW_223");
		ext_report.config().reportHeadline("-EW_223"); 
