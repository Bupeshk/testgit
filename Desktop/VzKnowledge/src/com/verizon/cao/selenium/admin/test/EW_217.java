...
import com.verizon.cao.selenium.admin.pages.FeedBackReportsGeneralPage;
...
public class EW_217  extends SetupBase implements Admin,Common {
	...
	public static ExtentReports ext_report = new ExtentReports(ApplicationConstants.REPORT_PATH + "\\EW_217.html", true,DisplayOrder.OLDEST_FIRST);
	private ExtentTest test; 
	public EW_217() throws Exception {
		super();
	}

	@Test
	public void FeedBackReportContentPageTest() throws Exception
	{
		test = ext_report.startTest("EW_217");
		ReportsPageTest reportsPageTest = new ReportsPageTest();
		reportsPageTest.ReportsPageTest();
		ReportsPage.ReportTabs(driver, "Feedback Report - Content").click();
		Thread.sleep(1000);
		wait = new WebDriverWait(driver,300);
		wait.until(ExpectedConditions.invisibilityOfElementLocated(By.xpath(lblPageLoading)));
		CommonFunctions.waitForElementPresentWebdriver(attributeName_xpath, imgFeedBackType, "Wait for Business Group", driver, ext_report, test);
		...
		Thread.sleep(2000);
		driver.findElement(By.xpath("//td//a[text() = 'VES']")).click();
		Thread.sleep(500);
		driver.findElement(By.xpath(lnkViewFeedback)).click();
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(txtFeedBackReport_Content_Title)));
		//CommonFunctions.waitForElementPresentWebdriver(attributeName_xpath, txtFeedBackReport_General_Title,"FeedBack Report - General", driver);
		String filePATH = "C:\\Users\\CHELLME\\Downloads\\vzk_ContentFeedback_Modified.xlsx";
		...
		Thread.sleep(4000);
		int numberOfRows = CommonFunctions.checkRowsForColumn("Title","C:\\Users\\CHELLME\\Downloads\\vzk_ContentFeedback_Modified.xlsx", "Sheet1");
		System.out.println("number of rows" +numberOfRows);
		AdminUtils.excelReader("C:\\Users\\CHELLME\\Downloads\\vzk_ContentFeedback_Modified.xlsx","Sheet1");
	...
	public  void setUp()throws Exception {
		Log.startTestCase("EW_217");
		Log.info("BeforeClass Method Invoked");
		ext_report.config().documentTitle("VzKnowledge Automation");
		ext_report.config().reportName("EW_217");
		ext_report.config().reportHeadline("-EW_217"); 
