...
public class EW_69 extends SetupBase implements Constants {
	...
	public void e_glossary() throws Exception {
		test = extent.startTest("Glossary");
		...
		midpage.chk_glossary_search(driver, EndUser.chk_search_glossary, "ihhuu", EndUser.find_glossary, extent,
				test);
		midpage.chk_filter_glossary(driver, EndUser.glossary_header, EndUser.chk_glossary_noitems,
