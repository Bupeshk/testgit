...
public class EW_120 extends SetupBase implements Constants{
	...
	public EW_120() throws Exception {
		super();
	}
	...
	public void access() throws Exception {
		...
		if (element.getText().contains("No recent updates are available.")){
			...
			test.log(LogStatus.PASS, "ALL Events", "All Events has an event and title is "+calender_title);
		}
		...
		if (element.getText().contains("No recent updates are available.")){
			...
			test.log(LogStatus.PASS, "Internal", "Internal has an event and title is "+calender_title);
		}
		...
		if (element.getText().contains("No recent updates are available.")){
			...
			test.log(LogStatus.PASS, "External", "External has an event and title is "+calender_title);
		}
