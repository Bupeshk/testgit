...
public class EW_100 extends SetupBase implements Constants{
	...
	public EW_100() throws Exception {
		super();
	}
	...
	public void setUp() throws Exception {
		...
		Log.startTestCase("NetworkBG_Author_Feedback_close");
	...
	public void feedback_inbox() throws Exception {
		test = extent.startTest("NetworkBG_Author_Feedback_close");
		...
		if (driver.findElement(By.xpath(EndUser.chk_feedback_close_cmt)).getText().contains(feedback_author_response)) {
			...
			test.log(LogStatus.FAIL, "Feedback Comment", "Close Feedback Comment is not listed in Close item");
