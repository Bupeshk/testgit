...
public class EW_127 extends SetupBase implements Constants{
	...
	public EW_127() throws Exception {
		super();
	}
	...
	public void setUp() throws Exception {
		...
		Log.startTestCase("NetworkBG_Validate_Request");
		Log.info("BeforeClass Method Invoked");
		extent = Ext_Report.Instance("End_User");
	}
	@Test
	public void val_acccess_req() throws Exception{
		test = extent.startTest("NetworkBG_Validate_Request");
		...
		if (cmf.existsElement(EndUser.find_role_name + "'" + B_Role_access + "']", driver) == true) {
			System.out.println("Newly added role exist");
			Log.info("Newly added role: " + B_Role_access + "exist");
			test.log(LogStatus.PASS, "Role", "Newly added role: " + B_Role_access + "exist");
		} else {
