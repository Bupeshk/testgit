...
public class EW_124 extends SetupBase implements Constants {
	...
	public EW_124() throws Exception {
		super();
	}
	...
	public void setUp() throws Exception {
		...
		Log.startTestCase("NetworkBG_Communication_Hub");
	...
	public void communication() {
		test = extent.startTest("NetworkBG_Communication_Hub");
		...
		if (get_content_type != null) {
			...
			if (!get_unread_count.equals(get_unread_count1)) {
				...
				test.log(LogStatus.FAIL, "Content Count",
						"Content count is not reduced by one and the count is " + get_unread_count1);
			}
		} else {
