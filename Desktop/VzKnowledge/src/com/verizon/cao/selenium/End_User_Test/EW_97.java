...
public class EW_97 extends SetupBase implements Constants{
	...
	public void setUp() throws Exception {
		...
		Log.startTestCase("NetworkBG_Admin_Feedback_close");
	...
	public void feedback_inbox() throws Exception {
		test = extent.startTest("NetworkBG_Admin_Feedback_close");
		...
		if (driver.findElement(By.xpath(EndUser.chk_feedback_close_cmt)).getText().contains(feedback_admin_response)) {
			...
			test.log(LogStatus.FAIL, "Feedback Comment", "Closed Feedback Comment is not listed in Close item");
