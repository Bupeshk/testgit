...
public class EW_59 extends SetupBase implements Constants {
	...
	public void setUp() throws Exception {
		...
		Log.startTestCase("EndUser_Author_Feedback");
...
//		System.out.println("inside before class" + baseurl);
	...
	public void feedback_inbox() throws Exception {
		test = extent.startTest("EndUser_Author_Feedback");
		...
		if (cmf.existsElement(EndUser.chk_user_content + feedback_user_name + "')]" + EndUser.chk_user_content_gear,
			...
			Ext_Report.CaptureScreen(driver, Screen_PATH+"EW_59");
			Log.info("Newly added Content is not listed in the My Feed");
			test.log(LogStatus.FAIL, "Content", "Newly added Content is not listed in the My Feed "+test.addScreenCapture(Report_Screen_PATH+"EW_59.png"));
		...
		if (cmf.existsElement(EndUser.message_total_page, driver) == true) {
			...
			test.log(LogStatus.FAIL, "Feedback", "Feedback is not listed with the Action 'View Details "+test.addScreenCapture(Report_Screen_PATH+"EW_59.png"));
