...
public class EW_72 extends SetupBase implements Constants {
	...
	public void setUp() throws Exception {
		...
		Log.startTestCase("Trending_section");
...
//		System.out.println("inside before class" + baseurl);
	...
	public void trending_section() throws Exception {
		test = extent.startTest("Trending_section");
