...
public class EW_99 extends SetupBase implements Constants{
	...
	public void setUp() throws Exception {
		...
		Log.startTestCase("NetworkBG_Author_Feedback_Inbox");
	...
	public void feedback_inbox() throws Exception {
		test = extent.startTest("NetworkBG_Author_Feedback_Inbox");
