...
public class EW_68 extends SetupBase implements Constants {
...
//		System.out.println("inside before class" + baseurl);
	...
	public void training() throws Exception {
		test = extent.startTest("Training");
		...
		cmf.mouse_ie(driver, EndUser.mouse_training, "Training", extent, test);
		...
		endTop.search_box(driver, EndUser.clk_training_search, "VZLearn", EndUser.clk_training_search_result,
				extent, test);
		cmf.sleep(5000);
		cmf.mouse_ie(driver, EndUser.mouse_vzknowledge, "VZKnowledge", extent, test);
		//cmf.mouse_hover(driver, EndUser.mouse_vzknowledge, "VZKnowledge", extent, test);
		cmf.sleep(10000);
		cmf.mouse_ie(driver, EndUser.mouse_training_modules, "Training_Modules", extent, test);
			 //cmf.mouse_hover(driver,
			 //EndUser.mouse_training_modules,"Training_Modules",extent,
			 //test);
			 try {
				 //driver.findElement(By.linkText("Training Modules")).click();
			cmf.sleep(5000);
			...
			Reporter.log("Exception occured while clicking Admin Training link " + e);
