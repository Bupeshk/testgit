...
public class EW_85 extends SetupBase implements Constants {
	...
	@Test
	public void help_link() throws Exception {
		...
		if (driver.getCurrentUrl() != null) {
			...
			test.log(LogStatus.FAIL, "HelpDesk URL", "Helpdesk Url not found or it may not be open");
			Reporter.log("Helpdesk Url not found or it may not be open");
			throw new Exception("Helpdesk Url not found or it may not be open");
		}
		cmf.sleep(1000);
