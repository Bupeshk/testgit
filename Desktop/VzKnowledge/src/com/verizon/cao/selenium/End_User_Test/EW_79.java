...
public class EW_79 extends SetupBase implements Constants {
	private ExtentReports extent;
	private ExtentTest test;
	CommonFunctions cmf = new CommonFunctions();
	MiddlePage midpage = new MiddlePage();

	public EW_79() throws Exception {
		super();
	}
	...
	public void setUp() throws Exception {
		...
		Log.startTestCase("Custom_Profile");
	...
	public void custom_profile() {
		test = extent.startTest("Custom_Profile");
		...
		do {
			...
			//driver.findElement(By.xpath(EndUser.custom_region)).click();
			chk_element(driver,EndUser.select_custom_region,EndUser.custom_region_obj);
			cmf.clkElement(driver, EndUser.custom_current_profile, "Current Profile", extent, test);
