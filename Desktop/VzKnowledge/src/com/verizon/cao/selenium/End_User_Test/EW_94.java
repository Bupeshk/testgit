...
public class EW_94 extends SetupBase implements Constants {
	...
	public void setUp() throws Exception {
		...
		Log.startTestCase("NetworkBG_Content_details");
	...
	public void chk_content_list() throws Exception {
		test = extent.startTest("NetworkBG_Content_details");
		...
		cmf.clkElement(driver, Content, "Content", extent, test);
		...
		if (driver.findElement(By.xpath(EndUser.chk_comment_msg)).getText()
			...
			rb.keyRelease(KeyEvent.VK_ACCEPT);
			...
			test.log(LogStatus.INFO, "Content Type", "Content type may be 'EXCEL' or 'DOC'");
		}
