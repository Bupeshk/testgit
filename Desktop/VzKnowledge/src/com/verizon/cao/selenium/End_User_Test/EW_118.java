...
public class EW_118 extends SetupBase implements Constants{
	
	private ExtentReports extent;
	private ExtentTest test;
CommonFunctions cmf = new CommonFunctions();
	MiddlePage midpage = new MiddlePage();
	public EW_118() throws Exception {
		super();
	}
	...
	public  void setUp()throws Exception {
		...
		Log.startTestCase("NetworkBG_Custom_Profile");
	...
	public void custom_profile(){
		test = extent.startTest("NetworkBG_Custom_Profile");
