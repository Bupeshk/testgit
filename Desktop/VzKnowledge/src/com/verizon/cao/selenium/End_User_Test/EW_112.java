...
public class EW_112 extends SetupBase implements Constants{
	private ExtentReports extent;
	private ExtentTest test;
	CommonFunctions cmf = new CommonFunctions();
	MiddlePage midpage = new MiddlePage();
	WebDriver driver = CommonFunctions.driver;
	public EW_112() throws Exception {
		super();
	}
	...
	public void setUp() throws Exception {
		...
		Log.startTestCase("NetworkBG_Trending_Action");
...
//		System.out.println("inside before class" + baseurl);
	...
	@Test
	public void tren_action(){
		test = extent.startTest("NetworkBG_Trending_Action");
