...
public class EW_71 extends SetupBase implements Constants {
	...
	public void setUp() throws Exception {
		...
		Log.startTestCase("Trending_menu");
...
/*		baseurl = super.getTestBaseUrl();
	...
	public void trending_menu() throws Exception {
		test = extent.startTest("Trending_menu");
		...
		for (int trend = 0; trend < trending_section.length; trend++) {
			...
			if (cmf.existsElement(
				...
				Log.info("Trending Section " + trending_section[trend] + " display side drop down with items");
				test.log(LogStatus.PASS, trending_section[trend],
						"Trending Section " + trending_section[trend] + " display side drop down with items");
			} else {
				Log.info("Trending Section " + trending_section[trend] + " is not appeared");
				test.log(LogStatus.FAIL, "Trending",
						"Trending Section " + trending_section[trend] + " is not appeared");
			}
		}
	}
