...
public class Callout_details {
	...
	private static PropertyUtility  putil = new PropertyUtility(Constant.CALLOUT_DETAIL_FILEPATH);
	...
	public static String Str_CalloutDetails_Path =  CCRHeader+":"+CCRHeader1+":"+ CalloutLines;
	...
	public static boolean CompareQtyOnHand(String col1, String col2, String row1, String row2) {
	    try {
