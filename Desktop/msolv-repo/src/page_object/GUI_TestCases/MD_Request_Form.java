...
public class MD_Request_Form {
	...
	private static PropertyUtility  putil = new PropertyUtility(GUI_Constant.MD_REQUEST_FORM_FILEPATH);
	...
	public static String Pickup_Instructions = putil.getEnvironmentProperty("Pickup_Instructions");
