...
public class KOIMSO_47 {
	...
	public void PKMS_340(String BrowserType, String testCaseId) throws Exception
	{
		...
		String PKMStestdatapath = ExcelUtils.getExcelData("TestData_Path", "KOIMSO_47");
		String InputPKMSXMLFilename = ExcelUtils.getExcelData("Input_XML_Name", "KOIMSO_47");
		String ResponsePKMSXMLFilename = ExcelUtils.getExcelData("Response_XML_Name", "KOIMSO_47");
		String UpdatedPKMSXMLFilename = ExcelUtils.getExcelData("Updated_XML_Name", "KOIMSO_47");
