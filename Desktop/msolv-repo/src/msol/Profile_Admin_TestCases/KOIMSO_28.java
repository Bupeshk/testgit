...
public class KOIMSO_28 {
  ...
  public void beforeMethod(String BrowserType) throws Exception {
    ...
    public void main(String testCaseId) throws Exception {
    	...
    	AssignQualityAdministratorEmailAddress_Admin_Extent_Test  = extent.startTest(testCaseId, "");
  	    SignIn_Action.Execute(AssignQualityAdministratorEmailAddress_Admin_Extent_Test, driver);
   
  		System.out.println("Login Successfully.");
  		Log.info("Login Successfully.");
  		AssignQualityAdministratorEmailAddress_Admin_Extent_Test.log(LogStatus.PASS, "Login Successfully.");
        ...
        Log.info("Implicit wait applied on the driver for 10 seconds");
  		...
  		AssignQualityAdministratorEmailAddress_Admin_Extent_Test.log(LogStatus.PASS, "Click action performed on Admin ");
  		...
  		AssignQualityAdministratorEmailAddress_Admin_Extent_Test.log(LogStatus.PASS, "Click action performed on Assign Quality Administrator Email Address");
  		...
  		AssignQualityAdministratorEmailAddress_Admin_Extent_Test.log(LogStatus.PASS, "Assign Quality Administrator Email Address function is done Successfully.");
    ...
    public void afterMethod() {
		...
		extent.endTest(AssignQualityAdministratorEmailAddress_Admin_Extent_Test);
		extent.flush()	;
