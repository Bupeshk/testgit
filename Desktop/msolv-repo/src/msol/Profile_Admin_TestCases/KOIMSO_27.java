...
public class KOIMSO_27 {
  ...
  public void beforeMethod(String BrowserType) throws Exception {
    ...
    public void main(String testCaseId) throws Exception {
    	...
    	AssignExternalReportURL_Admin_Extent_Test  = extent.startTest(testCaseId, "");
  	    SignIn_Action.Execute(AssignExternalReportURL_Admin_Extent_Test, driver);
   
  		System.out.println("Login Successfully.");
  		Log.info("Login Successfully.");
  		AssignExternalReportURL_Admin_Extent_Test.log(LogStatus.PASS, "Login Successfully.");
        ...
        Log.info("Implicit wait applied on the driver for 10 seconds");
  		...
  		AssignExternalReportURL_Admin_Extent_Test.log(LogStatus.PASS, "Click action performed on Admin ");
  		...
  		AssignExternalReportURL_Admin_Extent_Test.log(LogStatus.PASS, "Click action performed on Assign External Report URL ");
  		Utils.sleep(3000);
  		...
  		AssignExternalReportURL_Admin_Extent_Test.log(LogStatus.PASS, "Assign External Report URL function is done Successfully.");
  		Utils.sleep(3000);
    ...
    public void afterMethod() {
		...
		extent.endTest(AssignExternalReportURL_Admin_Extent_Test);
		extent.flush()	;
