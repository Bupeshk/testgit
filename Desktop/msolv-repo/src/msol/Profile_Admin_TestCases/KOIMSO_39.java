...
public class KOIMSO_39 {
  ...
  public void beforeMethod(String BrowserType) throws Exception {
    ...
    public void MassUpdateAdmin(String testCaseId) throws Exception {
    	MassUpdateAdmin_Admin_Extent_Test  = extent.startTest(testCaseId, "");
   
  	    SignIn_Action.Execute(MassUpdateAdmin_Admin_Extent_Test, driver);
   
  		System.out.println("Login Successfully.");
  		Log.info("Login Successfully.");
  		MassUpdateAdmin_Admin_Extent_Test.log(LogStatus.PASS, "Login Successfully.");
        ...
        Log.info("Implicit wait applied on the driver for 10 seconds");
  		...
  		MassUpdateAdmin_Admin_Extent_Test.log(LogStatus.PASS, "Click action performed on Admin ");
  		...
  		MassUpdateAdmin_Admin_Extent_Test.log(LogStatus.PASS, "Click action performed on Mass Update Admin");
  		...
  		MassUpdateAdmin_Admin_Extent_Test.log(LogStatus.PASS, "Click action performed on ADD");
        ...
        SetSendKeys_Action.Execute(MassUpdateAdmin_Admin_Extent_Test, grpMDCreateFields, grpMDCreateValues);
  		...
  		MassUpdateAdmin_Admin_Extent_Test.log(LogStatus.PASS," Mass Update Admin function is done Successfully.");
  		...
  		MassUpdateAdmin_Admin_Extent_Test.log(LogStatus.PASS, "Click action performed on Delete");
  		Log.info(" Mass Update Admin function is done Successfully.");
  		MassUpdateAdmin_Admin_Extent_Test.log(LogStatus.PASS, " Mass Update Admin function is done Successfully.");
    ...
    public void afterMethod() {
		...
		extent.endTest(MassUpdateAdmin_Admin_Extent_Test);
		extent.flush();
